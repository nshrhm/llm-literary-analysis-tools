...
def main():
    # コマンドライン引数の設定
    parser = argparse.ArgumentParser(description='ペルソナ理由統計の分析スクリプト')
    ...
    # 入力データを読み込む
    input_path = f"{OUTPUT_DIR}/persona_reason_average.csv"
    ...
    # CSVファイルとして保存
    output_path = f"{OUTPUT_DIR}/persona_reason_statistics.csv"
